%% ================================================
%  BEAN CLASSIFICATION — RANDOM FOREST
%  Statistics and Machine Learning Toolbox
%% ================================================

%% 1. LOAD DATA
data = readtable('Dry_Bean_Dataset.xlsx');   % <-- replace with your filename

% Separate features and labels
% Assumes last column is the bean class label
...
forest = TreeBagger(numTrees, X_train, Y_train, ...
    ...
    'OOBPrediction',   'on', ...            % Enables out-of-bag error tracking
    'OOBPredictorImportance', 'on', ...     % Enables feature importance
    'MinLeafSize',     1);                  % Default grown-out trees
